                ...
                <ul class="nav side-menu">
                  <?php
                    ...
                    for ($i=0; $i < $n; $i++) { 
                      ...
                      ## MENAMPILKAN MENU BERDASARKAN LEVEL USER SAJA ##
                      if ($datamenu[$i]['level'] == '' OR $datamenu[$i]['level'] == $leveluser) {

                        ## JIKA TIDAK MEMILIKI SUBMENU ##
                        if (empty($datamenu[$i]['submenu'])) {

                          ## JIKA MENU YANG DIBUKA SAMA DENGAN URL MAKA CLASS MENJADI AKTIF ##
                          if($datamenu[$i]['linked']==$uri[0]){

                             $classmenuaktif="class='active'";
                          }elseif(($uri[0]=='' OR $uri[0]=='home' OR $uri[0]== 'main')  AND $datamenu[$i]['linked']==''){
                       ...
                       ## JIKA MEMILIKI SUBMENU ##
                          ...
                          for ($j=0; $j < $ns; $j++) { 
                            $potong = explode(",", $submenu[$j]);

                            if ($uri[0] == $potong[0]) {
                              
                              $subactive = 'open active';
                            }else{
                            ...
                            echo "
                                  <li><a href='".base_url().$potong[0]."'>$potong[1]</a></li>
                                  ";
                          }
